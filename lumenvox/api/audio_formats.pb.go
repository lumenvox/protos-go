...
type AudioFormat struct {
	...
	// This field is optional. Specify it only for RAW (headerless) multi-channel audio formats such as stereo PCM or ULAW.
	// For audio formats with headers (WAV, MP3, etc.), this value is ignored; the value from the file header will be used instead.
	// Default: 1 (mono)
	ChannelCount *OptionalInt32 `protobuf:"bytes,3,opt,name=channel_count,json=channelCount,proto3" json:"channel_count,omitempty"`
}
...
func (x *AudioFormat) GetChannelCount() *OptionalInt32 {
	if x != nil {
...
var file_lumenvox_api_audio_formats_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa6, 0x05, 0x0a, 0x0b, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x46, 0x6f,
	...
	,
	...
	0x70, 0x69, 0xa2, 0x02, 0x05, 0x43, 0x4c, 0x56, 0x4f, 0x50, 0xaa, 0x02, 0x19, 0x4c, 0x75, 0x6d,
	0x65, 0x6e, 0x56, 0x6f, 0x78, 0x2e, 0x41, 0x70, 0x69, 0x2e, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x46,
	0x6f, 0x72, 0x6d, 0x61, 0x74, 0x73, 0xca, 0x02, 0x19, 0x4c, 0x75, 0x6d, 0x65, 0x6e, 0x56, 0x6f,
	0x78, 0x5c, 0x41, 0x70, 0x69, 0x5c, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x46, 0x6f, 0x72, 0x6d, 0x61,
...
var file_lumenvox_api_audio_formats_proto_depIdxs = []int32{
	...
	2, // 2: lumenvox.api.AudioFormat.channel_count:type_name -> lumenvox.api.OptionalInt32
